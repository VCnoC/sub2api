export default {
    ...
    groups: {
      ...
      subscription: {
		...
		billingMode: 'Subscription billing mode',
		billingModeHint: 'Request-count mode counts successful text generation requests only; failed requests are not charged.',
		billingModeUsd: 'USD usage',
		billingModeRequestCount: 'Successful request count',
		requestLimit5h: '5-hour request limit',
		requestLimit1d: '24-hour request limit',
		requestLimitHint: '0 disables that window; both windows cannot be 0. Windows start on the first successful request.',
		requestLimitRequired: 'The 5-hour and 24-hour request limits cannot both be 0',
		window5h: '5 hours',
		window1d: '24 hours',
