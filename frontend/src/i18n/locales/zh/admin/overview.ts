export default {
    ...
    groups: {
      ...
      subscription: {
        ...
        subscription: '订阅（配额）',
		billingMode: '订阅计费方式',
		billingModeHint: '按次数仅统计成功的文本生成请求，失败请求不扣次数。',
		billingModeUsd: '按 USD 用量',
		billingModeRequestCount: '按成功请求次数',
		requestLimit5h: '5 小时请求上限',
		requestLimit1d: '24 小时请求上限',
		requestLimitHint: '0 表示该窗口不限；两个窗口不能同时为 0。窗口从首次成功请求开始。',
		requestLimitRequired: '5 小时和 24 小时请求上限不能同时为 0',
		window5h: '5 小时',
		window1d: '24 小时',
        dailyLimit: '每日限额（USD）',
