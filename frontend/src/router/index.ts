...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    path: '/tickets',
    name: 'Tickets',
    component: () => import('@/views/user/tickets/TicketsView.vue'),
    meta: {
      requiresAuth: true,
      requiresAdmin: false,
  ...
  },
  {
    path: '/tickets/:id',
    name: 'TicketDetail',
    component: () => import('@/views/user/tickets/TicketDetailView.vue'),
    meta: {
      requiresAuth: true,
      requiresAdmin: false,
  ...
  },
  {
    ...
    component: () => import('@/views/user/ExternalPurchaseView.vue'),
    meta: {
      requiresAuth: true,
      requiresAdmin: false,
      ...
      requiresPurchaseSubscription: true
    }
  },
  {
    path: '/orders',
  ...
  },
  {
    path: '/admin/tickets',
    name: 'AdminTickets',
    component: () => import('@/views/admin/tickets/AdminTicketsView.vue'),
    meta: {
      requiresAuth: true,
      requiresAdmin: true,
  ...
  },
  {
    path: '/admin/teams',
    name: 'AdminTeams',
    component: () => import('@/views/admin/teams/AdminTeamsView.vue'),
    meta: {
      requiresAuth: true,
      requiresAdmin: true,
      title: 'Team Management',
      titleKey: 'teamAdmin.title',
      descriptionKey: 'teamAdmin.description'
    }
  },
  {
    path: '/admin/tickets/:id',
    name: 'AdminTicketDetail',
    component: () => import('@/views/admin/tickets/AdminTicketDetailView.vue'),
    meta: {
      requiresAuth: true,
      requiresAdmin: true,
      title: 'Ticket Detail',
      titleKey: 'tickets.adminDetailTitle'
    }
  },
  {
    path: '/admin/groups',
...
router.beforeEach(async (to, _from, next) => {
  ...
  // Check external purchase page requirement
  if (to.meta.requiresPurchaseSubscription) {
    const purchaseEnabled = appStore.cachedPublicSettings?.purchase_subscription_enabled
    if (!purchaseEnabled) {
      next(authStore.isAdmin ? '/admin/dashboard' : '/dashboard')
      return
    }
  ...
  // Check risk control requirement
  // Only an explicit value from successfully loaded settings can disable a route.
  // A transient settings failure is unknown state, not a confirmed feature toggle.
  if (
