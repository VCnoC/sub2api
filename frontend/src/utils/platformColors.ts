...
const BADGE_LIGHT: Record<Platform, string> = {
  ...
  video: 'bg-cyan-500/10 text-cyan-700 dark:text-cyan-300',
}
...
const ACCENT_BAR: Record<Platform, string> = {
  ...
  video: 'bg-gradient-to-r from-cyan-500 to-teal-500',
}
...
const ICON: Record<Platform, string> = {
  ...
  grok: 'text-zinc-800 dark:text-zinc-200',
  video: 'text-cyan-600 dark:text-cyan-300',
}
...
const BUTTON: Record<Platform, string> = {
  ...
  video: 'bg-cyan-600 text-white hover:bg-cyan-700 active:bg-cyan-800 dark:bg-cyan-700 dark:hover:bg-cyan-600',
}
...
const GRADIENT: Record<Platform, string> = {
  ...
  video: 'from-cyan-500 to-teal-500',
}
