<template>
  ...
  >
    <!-- Logo/Brand -->
    <div class="sidebar-header border-none" :class="{ 'sidebar-header-collapsed': sidebarCollapsed }">
      <!-- Custom Logo or Default Logo -->
      <router-link
        :to="homePath"
        class="sidebar-logo flex h-9 w-9 items-center justify-center overflow-hidden rounded-xl bg-white/50 dark:bg-white/5 shadow-sm ring-1 ring-black/5 dark:ring-white/10 backdrop-blur-md transition-opacity hover:opacity-80"
        ...
        <div class="sidebar-section">
          <template v-for="item in adminNavItems" :key="item.path">
            ...
            >
              ...
              <span v-if="item.badge" class="ticket-unread-badge" :aria-label="t('tickets.unreadCount', { count: item.badge })">
...
const flagPurchaseSubscription = makeSidebarFlag(FeatureFlags.purchaseSubscription)
...
function buildSelfNavItems(withDashboard: boolean): NavItem[] {
  ...
  items.push(
    ...
    { path: '/playground', label: t('nav.playground'), icon: ChatBubbleIcon, hideInSimpleMode: true },
    { path: '/tickets', label: t('nav.tickets'), icon: TicketIcon, badge: ticketStore.unreadCount },
    { path: '/batch-image', label: t('nav.batchImage'), icon: BatchImageIcon, hideInSimpleMode: true, featureFlag: flagBatchImageAccess },
    { path: '/usage', label: t('nav.usage'), icon: ChartIcon, hideInSimpleMode: true },
    { path: '/available-channels', label: t('nav.availableChannels'), icon: ChannelIcon, hideInSimpleMode: true, featureFlag: flagAvailableChannels },
    { path: '/monitor', label: t('nav.channelStatus'), icon: SignalIcon, featureFlag: flagChannelMonitor },
    { path: '/subscriptions', label: t('nav.mySubscriptions'), icon: CreditCardIcon, hideInSimpleMode: true },
    { path: '/purchase', label: t('nav.buySubscription'), icon: RechargeSubscriptionIcon, hideInSimpleMode: true, featureFlag: flagPurchaseSubscription },
    ...
    { path: '/team', label: t('nav.team'), icon: UsersIcon },
...
const adminNavItems = computed((): NavItem[] => {
  const baseItems: NavItem[] = [
    ...
    { path: '/admin/lottery', label: t('lotteryAdmin.title'), icon: GiftIcon, hideInSimpleMode: true },
    {
...
onMounted(() => {
  ticketStore.startUnreadPolling(isAdmin.value)
...
<style scoped>
.ticket-unread-badge {
  @apply ml-auto inline-flex h-5 min-w-5 flex-shrink-0 items-center justify-center rounded-full bg-red-500 px-1 text-[10px] font-semibold leading-none text-white;
}
