<template>
  ...
  <svg v-else-if="platform === 'video'" :class="sizeClass" viewBox="0 0 24 24" fill="currentColor">
    <path d="M4.5 5.25A2.25 2.25 0 002.25 7.5v9a2.25 2.25 0 002.25 2.25h10.125a2.25 2.25 0 002.25-2.25v-9a2.25 2.25 0 00-2.25-2.25H4.5zm13.875 3.43a.75.75 0 00-.375.65v5.34a.75.75 0 00.375.65l2.25 1.299a.75.75 0 001.125-.65V8.031a.75.75 0 00-1.125-.65l-2.25 1.299z" />
  </svg>
