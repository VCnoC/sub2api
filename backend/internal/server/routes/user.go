	...
	authenticated.Use(gin.HandlerFunc(auditLog))
	{
		...
		user := authenticated.Group("/user")
		{
			...
			team := user.Group("/team")
			{
				...
				team.GET("/application", h.Team.GetMyCreateApplication)
				team.GET("/eligibility", h.Team.GetCreationEligibility)
				team.POST("/invite-code", h.Team.RefreshInviteCode)
				team.POST("/join", h.Team.JoinTeam)
				team.GET("/join-requests", h.Team.ListJoinRequests)
				team.POST("/join-requests/:id/review", h.Team.ReviewJoinRequest)
				team.GET("/governance", h.Team.GetGovernanceState)
				team.POST("/upgrade", h.Team.UpgradeTeam)
				team.POST("/expand", h.Team.SubmitExpandApplication)
