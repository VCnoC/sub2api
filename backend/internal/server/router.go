...
func SetupRouter(
	...
	// 注册路由
	registerRoutes(r, handlers, jwtAuth, adminAuth, apiKeyAuth, auditLog, stepUpAuth, apiKeyService, userService, subscriptionService, opsService, settingService, cfg, redisClient)
...
func registerRoutes(
	...
	routes.RegisterPlaygroundRoutes(v1, h, jwtAuth, apiKeyService, userService, subscriptionService, opsService, settingService, cfg)
