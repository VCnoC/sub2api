...
func userSubscriptionFromServiceBase(sub *service.UserSubscription) UserSubscription {
	return UserSubscription{
		...
		RequestUsage5h:       sub.RequestUsage5h,
		RequestUsage1d:       sub.RequestUsage1d,
		RequestWindow5hStart: sub.RequestWindow5hStart,
		RequestWindow1dStart: sub.RequestWindow1dStart,
