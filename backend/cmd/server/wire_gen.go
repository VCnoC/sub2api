...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	lotteryChanceService := service.NewLotteryChanceService(lotteryRepository)
	affiliateService := service.ProvideAffiliateService(affiliateRepository, settingService, apiKeyAuthCacheInvalidator, billingCacheService, lotteryChanceService)
	...
	redeemService := service.ProvideRedeemService(redeemCodeRepository, userRepository, subscriptionService, redeemCache, billingCacheService, client, apiKeyAuthCacheInvalidator, affiliateService, lotteryChanceService)
	...
	teamGovernanceRepository := repository.NewTeamGovernanceRepository(db)
	usageLogRepository := repository.NewUsageLogRepository(client, db)
	teamService := service.NewTeamService(teamRepository, teamGovernanceRepository, userRepository, usageLogRepository, authService, billingCacheService)
	...
	ticketRepository := repository.NewSupportTicketRepository(db)
	ticketFileStore := service.NewTicketFileStore()
	ticketService := service.NewTicketService(ticketRepository, ticketFileStore, notificationEmailService)
	supportTicketHandler := handler.NewSupportTicketHandler(ticketService)
	...
	adminSupportTicketHandler := admin.NewSupportTicketHandler(ticketService)
	...
	paymentService := service.ProvidePaymentService(client, registry, defaultLoadBalancer, redeemService, subscriptionService, paymentConfigService, userRepository, groupRepository, affiliateService, notificationEmailService, lotteryChanceService)
	...
	lotteryService := service.NewLotteryService(lotteryRepository, redeemService, groupRepository, client, apiKeyAuthCacheInvalidator, billingCacheService)
	lotteryHandler := admin.NewLotteryHandler(lotteryService)
	auditLogRepository := repository.NewAuditLogRepository(db)
	auditLogService := service.ProvideAuditLogService(auditLogRepository, settingService)
	auditLogHandler := admin.NewAuditLogHandler(auditLogService, totpService)
	adminTeamHandler := admin.NewTeamHandler(teamService)
	upstreamBillingProbeService := service.ProvideUpstreamBillingProbeService(accountRepository, accountTestService, settingService, leaderLockCache, db)
	adminHandlers := handler.ProvideAdminHandlers(dashboardHandler, adminUserHandler, groupHandler, accountHandler, adminAnnouncementHandler, adminSupportTicketHandler, dataManagementHandler, backupHandler, oAuthHandler, openAIOAuthHandler, geminiOAuthHandler, antigravityOAuthHandler, grokOAuthHandler, proxyHandler, adminRedeemHandler, promoHandler, settingHandler, opsHandler, systemHandler, adminSubscriptionHandler, adminUsageHandler, userAttributeHandler, errorPassthroughHandler, tlsFingerprintProfileHandler, adminAPIKeyHandler, scheduledTestHandler, channelHandler, channelMonitorHandler, channelMonitorRequestTemplateHandler, contentModerationHandler, promptAdminHandler, paymentHandler, affiliateHandler, complianceHandler, lotteryHandler, auditLogHandler, adminTeamHandler, upstreamBillingProbeService)
	...
	playgroundHandler := handler.NewPlaygroundHandler(apiKeyService, gatewayService)
	playgroundConversationRepository := repository.NewPlaygroundConversationRepository(client)
	playgroundConversationService := service.NewPlaygroundConversationService(playgroundConversationRepository)
	playgroundConversationHandler := handler.NewPlaygroundConversationHandler(playgroundConversationService)
	...
	handlers := handler.ProvideHandlers(authHandler, userHandler, teamHandler, apiKeyHandler, usageHandler, redeemHandler, subscriptionHandler, announcementHandler, supportTicketHandler, channelMonitorUserHandler, adminHandlers, gatewayHandler, openAIGatewayHandler, handlerSettingHandler, totpHandler, handlerPaymentHandler, paymentWebhookHandler, availableChannelHandler, playgroundHandler, playgroundConversationHandler, asyncImageHandler, batchImageHandler, handlerLotteryHandler, idempotencyCoordinator, idempotencyCleanupService)
	...
	engine := server.ProvideRouter(configConfig, handlers, jwtAuthMiddleware, adminAuthMiddleware, apiKeyAuthMiddleware, auditLogMiddleware, stepUpAuthMiddleware, apiKeyService, userService, subscriptionService, opsService, settingService, redisClient)
	...
	videoTaskWorkerRuntime := service.ProvideVideoTaskWorkerRuntime(videoTaskRepository, accountRepository, httpUpstream, billingCacheService, configConfig)
	scheduledTestRunnerService := service.ProvideScheduledTestRunnerService(scheduledTestPlanRepository, scheduledTestService, accountTestService, rateLimitService, configConfig)
	paymentOrderExpiryService := service.ProvidePaymentOrderExpiryService(paymentService, leaderLockCache, db)
	channelMonitorRunner := service.ProvideChannelMonitorRunner(channelMonitorService, settingService)
	userPlatformQuotaUsageFlusher := service.ProvideUserPlatformQuotaUsageFlusher(configConfig, billingCache, serviceUserPlatformQuotaRepository, timingWheelService)
	playgroundConversationCleanupService := service.ProvidePlaygroundConversationCleanupService(playgroundConversationRepository, timingWheelService, configConfig)
	ticketAttachmentCleanupService := service.ProvideTicketAttachmentCleanupService(ticketService)
	v := provideCleanup(client, redisClient, opsMetricsCollector, opsAggregationService, opsAlertEvaluatorService, opsCleanupService, opsScheduledReportService, opsSystemLogSink, schedulerSnapshotService, tokenRefreshService, accountExpiryService, proxyExpiryService, subscriptionExpiryService, usageCleanupService, idempotencyCleanupService, batchImageCleanupService, batchImageWorkerRuntime, videoTaskWorkerRuntime, pricingService, emailQueueService, billingCacheService, usageRecordWorkerPool, subscriptionService, oAuthService, openAIOAuthService, geminiOAuthService, antigravityOAuthService, grokOAuthService, openAIGatewayService, scheduledTestRunnerService, backupService, paymentOrderExpiryService, channelMonitorRunner, userPlatformQuotaUsageFlusher, playgroundConversationCleanupService, ticketAttachmentCleanupService, upstreamBillingProbeService, auditLogService, promptService)
