...
func provideCleanup(
	...
	playgroundConvCleanup *service.PlaygroundConversationCleanupService,
) func() {
	return func() {
		...
		parallelSteps := []cleanupStep{
			...
			{"PlaygroundConversationCleanupService", func() error {
				if playgroundConvCleanup != nil {
					playgroundConvCleanup.Stop()
				}
				return nil
			}},
		}
