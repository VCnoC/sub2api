...
func provideCleanup(
	...
	videoTaskWorker *service.VideoTaskWorkerRuntime,
	...
	return func() {
		...
		parallelSteps := []cleanupStep{
			...
			{"VideoTaskWorkerRuntime", func() error {
				if videoTaskWorker != nil {
			...
			{"PlaygroundConversationCleanupService", func() error {
				if playgroundConversationCleanup != nil {
					playgroundConversationCleanup.Stop()
				}
				return nil
			}},
