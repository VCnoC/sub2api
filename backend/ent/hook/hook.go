...
// The PlaygroundConversationFunc type is an adapter to allow the use of ordinary
// function as PlaygroundConversation mutator.
type PlaygroundConversationFunc func(context.Context, *ent.PlaygroundConversationMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f PlaygroundConversationFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.PlaygroundConversationMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.PlaygroundConversationMutation", m)
}
...
// The SupportTicketAttachmentFunc type is an adapter to allow the use of ordinary
// function as SupportTicketAttachment mutator.
type SupportTicketAttachmentFunc func(context.Context, *ent.SupportTicketAttachmentMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f SupportTicketAttachmentFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.SupportTicketAttachmentMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.SupportTicketAttachmentMutation", m)
}
