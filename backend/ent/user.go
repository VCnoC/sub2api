...
type UserEdges struct {
	...
	// DeletedSupportTicketAttachments holds the value of the deleted_support_ticket_attachments edge.
	DeletedSupportTicketAttachments []*SupportTicketAttachment `json:"deleted_support_ticket_attachments,omitempty"`
...
// was not loaded in eager-loading.
func (e UserEdges) SubscriptionRequestReservationsOrErr() ([]*SubscriptionRequestReservation, error) {
	if e.loadedTypes[3] {
...
// DeletedSupportTicketAttachmentsOrErr returns the DeletedSupportTicketAttachments value or an error if the edge
// was not loaded in eager-loading.
func (e UserEdges) DeletedSupportTicketAttachmentsOrErr() ([]*SupportTicketAttachment, error) {
	if e.loadedTypes[11] {
		return e.DeletedSupportTicketAttachments, nil
	}
	return nil, &NotLoadedError{edge: "deleted_support_ticket_attachments"}
}
...
func (*User) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case user.FieldID, user.FieldConcurrency, user.FieldRpmLimit, user.FieldTeamID:
			values[i] = new(sql.NullInt64)
		case user.FieldEmail, user.FieldPasswordHash, user.FieldRole, user.FieldStatus, user.FieldUsername, user.FieldNotes, user.FieldTotpSecretEncrypted, user.FieldSignupSource, user.FieldBalanceNotifyThresholdType, user.FieldBalanceNotifyExtraEmails, user.FieldTeamRole:
...
// QuerySubscriptionRequestReservations queries the "subscription_request_reservations" edge of the User entity.
func (_m *User) QuerySubscriptionRequestReservations() *SubscriptionRequestReservationQuery {
	return NewUserClient(_m.config).QuerySubscriptionRequestReservations(_m)
}
...
// QueryDeletedSupportTicketAttachments queries the "deleted_support_ticket_attachments" edge of the User entity.
func (_m *User) QueryDeletedSupportTicketAttachments() *SupportTicketAttachmentQuery {
	return NewUserClient(_m.config).QueryDeletedSupportTicketAttachments(_m)
}
...
func (_m *User) String() string {
	...
	builder.WriteString(_m.TeamRole)
	builder.WriteByte(')')
