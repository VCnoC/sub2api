...
func checkColumn(t, c string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			...
			playgroundconversation.Table:         playgroundconversation.ValidColumn,
			...
			subscriptionrequestreservation.Table: subscriptionrequestreservation.ValidColumn,
			supportticket.Table:                  supportticket.ValidColumn,
			supportticketattachment.Table:        supportticketattachment.ValidColumn,
