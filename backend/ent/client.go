...
// QueryAssignee queries the assignee edge of a SupportTicket.
func (c *SupportTicketClient) QueryAssignee(_m *SupportTicket) *UserQuery {
	query := (&UserClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
			sqlgraph.From(supportticket.Table, supportticket.FieldID, id),
			sqlgraph.To(user.Table, user.FieldID),
			sqlgraph.Edge(sqlgraph.M2O, true, supportticket.AssigneeTable, supportticket.AssigneeColumn),
		)
		fromV = sqlgraph.Neighbors(_m.driver.Dialect(), step)
		return fromV, nil
	}
...
// QueryReads queries the reads edge of a SupportTicket.
func (c *SupportTicketClient) QueryReads(_m *SupportTicket) *SupportTicketReadQuery {
	query := (&SupportTicketReadClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
			sqlgraph.From(supportticket.Table, supportticket.FieldID, id),
			sqlgraph.To(supportticketread.Table, supportticketread.FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, supportticket.ReadsTable, supportticket.ReadsColumn),
		)
		fromV = sqlgraph.Neighbors(_m.driver.Dialect(), step)
		return fromV, nil
	}
...
// QueryDeletedByUser queries the deleted_by_user edge of a SupportTicketAttachment.
func (c *SupportTicketAttachmentClient) QueryDeletedByUser(_m *SupportTicketAttachment) *UserQuery {
	query := (&UserClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
...
// QueryAuthor queries the author edge of a SupportTicketMessage.
func (c *SupportTicketMessageClient) QueryAuthor(_m *SupportTicketMessage) *UserQuery {
	query := (&UserClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
			sqlgraph.From(supportticketmessage.Table, supportticketmessage.FieldID, id),
			sqlgraph.To(user.Table, user.FieldID),
			sqlgraph.Edge(sqlgraph.M2O, true, supportticketmessage.AuthorTable, supportticketmessage.AuthorColumn),
		)
		fromV = sqlgraph.Neighbors(_m.driver.Dialect(), step)
		return fromV, nil
	}
...
// QueryTicket queries the ticket edge of a SupportTicketRead.
func (c *SupportTicketReadClient) QueryTicket(_m *SupportTicketRead) *SupportTicketQuery {
	query := (&SupportTicketClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
			sqlgraph.From(supportticketread.Table, supportticketread.FieldID, id),
			sqlgraph.To(supportticket.Table, supportticket.FieldID),
...
// QueryUser queries the user edge of a SupportTicketRead.
func (c *SupportTicketReadClient) QueryUser(_m *SupportTicketRead) *UserQuery {
	query := (&UserClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
			sqlgraph.From(supportticketread.Table, supportticketread.FieldID, id),
			sqlgraph.To(user.Table, user.FieldID),
			sqlgraph.Edge(sqlgraph.M2O, true, supportticketread.UserTable, supportticketread.UserColumn),
		)
		fromV = sqlgraph.Neighbors(_m.driver.Dialect(), step)
		return fromV, nil
	}
...
// QueryDeletedSupportTicketAttachments queries the deleted_support_ticket_attachments edge of a User.
func (c *UserClient) QueryDeletedSupportTicketAttachments(_m *User) *SupportTicketAttachmentQuery {
	query := (&SupportTicketAttachmentClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
...
// QuerySupportTicketReads queries the support_ticket_reads edge of a User.
func (c *UserClient) QuerySupportTicketReads(_m *User) *SupportTicketReadQuery {
	query := (&SupportTicketReadClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
