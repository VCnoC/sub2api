...
func (_u *APIKeyUpdate) AddGroupBindingIDs(ids ...int64) *APIKeyUpdate {
	_u.mutation.AddGroupBindingIDs(ids...)
	return _u
}

// AddGroupBindings adds the "group_bindings" edges to the APIKeyGroup entity.
func (_u *APIKeyUpdate) AddGroupBindings(v ...*APIKeyGroup) *APIKeyUpdate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearGroupBindings clears all "group_bindings" edges to the APIKeyGroup entity.
func (_u *APIKeyUpdate) ClearGroupBindings() *APIKeyUpdate {
	_u.mutation.ClearGroupBindings()
	return _u
}

// RemoveGroupBindingIDs removes the "group_bindings" edge to APIKeyGroup entities by IDs.
func (_u *APIKeyUpdate) RemoveGroupBindingIDs(ids ...int64) *APIKeyUpdate {
	_u.mutation.RemoveGroupBindingIDs(ids...)
	return _u
}

// RemoveGroupBindings removes "group_bindings" edges to APIKeyGroup entities.
func (_u *APIKeyUpdate) RemoveGroupBindings(v ...*APIKeyGroup) *APIKeyUpdate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// AddGroupBindingIDs adds the "group_bindings" edge to the APIKeyGroup entity by IDs.
func (_u *APIKeyUpdateOne) AddGroupBindingIDs(ids ...int64) *APIKeyUpdateOne {
	_u.mutation.AddGroupBindingIDs(ids...)
	return _u
}

// AddGroupBindings adds the "group_bindings" edges to the APIKeyGroup entity.
func (_u *APIKeyUpdateOne) AddGroupBindings(v ...*APIKeyGroup) *APIKeyUpdateOne {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// RemoveGroupBindingIDs removes the "group_bindings" edge to APIKeyGroup entities by IDs.
func (_u *APIKeyUpdateOne) RemoveGroupBindingIDs(ids ...int64) *APIKeyUpdateOne {
	_u.mutation.RemoveGroupBindingIDs(ids...)
	return _u
}

// RemoveGroupBindings removes "group_bindings" edges to APIKeyGroup entities.
func (_u *APIKeyUpdateOne) RemoveGroupBindings(v ...*APIKeyGroup) *APIKeyUpdateOne {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
