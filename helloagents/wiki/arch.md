...
|--------|-------|------|--------|------------------|---------|
| ADR-20260724-RESTORE-001 | 使用语义三方合并恢复海外D增量 | 2026-07-24 | ✅已实施 | 兑换码、抽奖、设置、团队、前端 | [方案](../history/2026-07/202607240028_restore_overseas_d_features/how.md#adr-001-使用语义三方合并而非旧源码覆盖) |
| ADR-20260724-RESTORE-002 | 恢复迁移使用编号 191 | 2026-07-24 | ✅已实施 | 数据库、兑换码 | [方案](../history/2026-07/202607240028_restore_overseas_d_features/how.md#adr-002-恢复迁移使用编号-191) |
